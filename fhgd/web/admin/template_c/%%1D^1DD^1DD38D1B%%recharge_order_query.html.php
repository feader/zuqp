<?php /* Smarty version 2.6.25, created on 2017-08-10 17:53:14
         compiled from module/recharge_manager/recharge_order_query.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'module/recharge_manager/recharge_order_query.html', 69, false),)), $this); ?>
...
<div id="position">当前位置：充值系统 > 流水查询</div>
<div>
<div class="divOperation">

    <form name="myform" method="post" action="recharge_query.php">
...
<div>
    <p>总充值房卡：<?php echo $this->_tpl_vars['all_money']; ?>
</p>
    <p>查询区间总充值房卡：<?php echo $this->_tpl_vars['total']; ?>
</p>
</div>
<table id="tAgency" cellspacing="1" cellpadding="3" border="0" class='table_list' >
    ...
    <tbody>
    <?php $_from = $this->_tpl_vars['recharge_log_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['recharge_log']):
?>
        <tr class="<?php echo smarty_function_cycle(array('values' => 'trOdd, trEven'), $this);?>
">           
            <td>
                <?php echo $this->_tpl_vars['recharge_log']['date_time']; ?>

            </td>
            <td><?php echo $this->_tpl_vars['recharge_log']['today_total_dimond']; ?>
</td>         
        </tr>
