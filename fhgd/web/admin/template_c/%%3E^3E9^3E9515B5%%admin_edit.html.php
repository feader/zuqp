<?php /* Smarty version 2.6.25, created on 2017-07-20 18:14:01
...
<script type="text/javascript" src="../../../admin/static/js/My97DatePicker/WdatePicker.js"></script>
 ...
 <div id="position">当前位置：管理员编辑</div>
	<form action="admin_save.php" method="post">
		...
		<?php if ($this->_tpl_vars['detail']['gid'] == '1'): ?> 
		<br>
		修改管理员等级:<select name="gid">
...
" name="uid" />
		<input type="hidden" value="<?php echo $this->_tpl_vars['detail']['gid']; ?>
" name="ogid" />
