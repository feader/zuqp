...
$gm_sell_sql = "SELECT seller_uid,sum(dimond_num) as total_diamond FROM `t_sell_log` WHERE seller_uid in('hg0001','hg0002') and action_time between 0 and $dateEnd group by seller_uid";
...
if($_GET['action'] == 'search' ){
	...
	$gm_sell_sql = "SELECT seller_uid,sum(dimond_num) as total_diamond FROM `t_sell_log` WHERE seller_uid in('hg0001','hg0002') and action_time between $dateStart and $dateEnd group by seller_uid";
}
