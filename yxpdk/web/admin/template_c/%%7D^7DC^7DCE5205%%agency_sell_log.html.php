<?php /* Smarty version 2.6.25, created on 2017-09-02 16:35:07
         compiled from module/agency/agency_sell_log.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'module/agency/agency_sell_log.html', 66, false),array('modifier', 'date_format', 'module/agency/agency_sell_log.html', 70, false),)), $this); ?>
...
">
            <td><?php echo $this->_tpl_vars['log']['buyer_name']; ?>
</td>
            <td><?php echo $this->_tpl_vars['log']['dimond_num']; ?>
</td>
            <td><?php echo $this->_tpl_vars['log']['dimond_num']; ?>
</td>
            <td><?php echo ((is_array($_tmp=$this->_tpl_vars['log']['action_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y/%m/%d %H:%M:%S") : smarty_modifier_date_format($_tmp, "%Y/%m/%d %H:%M:%S")); ?>
</td>
        </tr>
