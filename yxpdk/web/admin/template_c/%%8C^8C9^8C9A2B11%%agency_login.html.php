<?php /* Smarty version 2.6.25, created on 2017-09-03 18:52:36
         compiled from module/agency/agency_login.html */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
<head>
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <title>代理管理后台</title>
    <link href="../../../admin/static/css/login_styles.css" type="text/css" media="screen" rel="stylesheet" />
    <meta id="viewport" name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0" />
    <script src="../../../admin/static/js/jquery-1.6.2.min.js"></script>
</head>
    ...
    <div id="wrapper">
        <div id="content">
            <div id="header">
                 <h1>
                    <div id='logo'>
                        <img src="../../../admin/static/images/pdk_logo.png" alt="logo">
                    </div>
                </h1>
            </div>
            ...
            <div>
            <form name="form1" method="post" action="agency_login.php">
...
"  /></span>
                ...
                <p>
                    <label class="loginlabel" for="validation">
                        <img src="../../image.php" id='change_code'></label><span>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function () {
            $('#switchlang').change(function() {
                ...
                $.post("../../../admin/login.php", {LANG:txt}, function(result){
