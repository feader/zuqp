<?php /* Smarty version 2.6.25, created on 2017-07-26 17:36:09
...
<body>
	<table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#A5D0F1">
        <tr bgcolor="#E5F9FF">
        	<td colspan="2" background="../admin/static/images/wbg.gif"><font color="#666600" class="STYLE2"><b>◆信息提示</b></font></td>
        </tr>
        <tr bgcolor="#FFFFFF">
          <td width="100%"><a href="<?php echo $this->_tpl_vars['url']; ?>
